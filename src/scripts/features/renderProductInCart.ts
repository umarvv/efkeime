export function renderProductInCart(name:string, price: number) {
    ...
    const productsInCartContainer = document.querySelector<HTMLDivElement>('#product--in--cart')
    if(!productsInCartContainer) return
